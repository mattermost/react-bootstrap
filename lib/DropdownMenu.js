...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(RootCloseWrapper, {
      disabled: !open,
      onRootClose: this.handleRootClose,
      event: rootCloseEvent,
      menuRef: this.menuRef
    }, _react.default.createElement("ul", (0, _extends3.default)({
      ref: this.menuRef
    }, elementProps, {
      role: "menu",
...
function RootCloseWrapper(_ref) {
  ...
  (0, _reactOverlays.useRootClose)(menuRef, onRootClose, {
    disabled: disabled,
    clickTrigger: event
  });
  return children;
