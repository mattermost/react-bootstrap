...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var handleEnter = (0, _createChainedFunction.default)(this.handleEnter, (0, _withRef.default)(onEnter, this.childRef));
    var handleEntering = (0, _createChainedFunction.default)(this.handleEntering, (0, _withRef.default)(onEntering, this.childRef));
    var handleEntered = (0, _createChainedFunction.default)(this.handleEntered, (0, _withRef.default)(onEntered, this.childRef));
    var handleExit = (0, _createChainedFunction.default)(this.handleExit, (0, _withRef.default)(onExit, this.childRef));
    var handleExiting = (0, _createChainedFunction.default)(this.handleExiting, (0, _withRef.default)(onExiting, this.childRef));
    var ref = (0, _mergeRefs.makeMergedRef)([this.childRef, (0, _mergeRefs.getElementRef)(children)]);
