...
function (_React$Component) {
  ...
  _proto.UNSAFE_componentWillUpdate = function UNSAFE_componentWillUpdate(nextProps) {
    if (!nextProps.open && this.props.open) {
      this._focusInDropdown = (0, _contains.default)(this.containerRef.current.querySelector('[role=menu]'), (0, _activeElement.default)(document));
    }
  };
  ...
  _proto.renderMenu = function renderMenu(child, _ref) {
    ...
    var ref = (0, _mergeRefs.makeMergedRef)([function (el) {
      _this2.menu = el;
    }, (0, _mergeRefs.getElementRef)(child)]);
  ...
  _proto.render = function render() {
    ...
    var missingRoleError = (0, _PropTypes.getMissingRoleError)('Dropdown', children, TOGGLE_ROLE, MENU_ROLE);

    if (missingRoleError) {
      process.env.NODE_ENV !== "production" ? (0, _warning.default)(false, missingRoleError) : void 0;
    }

    var duplicateRoleError = (0, _PropTypes.getDuplicateRoleError)('Dropdown', children, MENU_ROLE);

    if (duplicateRoleError) {
      process.env.NODE_ENV !== "production" ? (0, _warning.default)(false, duplicateRoleError) : void 0;
    }
