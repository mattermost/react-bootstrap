...
var _isOverflowing = _interopRequireDefault(require("react-overlays/isOverflowing"));
...
var DialogTransition = _react.default.forwardRef(function (props, ref) {
...
var BackdropTransition = _react.default.forwardRef(function (props, ref) {
  return _react.default.createElement(_Fade.default, (0, _extends2.default)({
    ref: ref
  }, props, {
...
function (_React$Component) {
  ...
  _proto.updateStyle = function updateStyle() {
    ...
    var bodyIsOverflowing = (0, _isOverflowing.default)(document.body);
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props, ["backdrop", "backdropClassName", "backdropStyle", "animation", "show", "dialogComponentClass", "className", "style", "children", "onEntering", "onExited"]);
    ...
    return _react.default.createElement(_ModalContext.default.Provider, {
    ...
    }, _react.default.createElement(_Modal.default, (0, _extends2.default)({}, baseModalProps, {
      ...
      renderBackdrop: function renderBackdrop(backdropProps) {
        return _react.default.createElement("div", (0, _extends2.default)({}, backdropProps, {
          className: (0, _classnames.default)((0, _bootstrapUtils.prefix)(props, 'backdrop'), backdropClassName, inClassName),
          style: (0, _extends2.default)({}, backdropProps.style, backdropStyle)
        }));
      },
      renderDialog: function renderDialog(renderProps) {
        return _react.default.createElement(Dialog, (0, _extends2.default)({}, dialogProps, renderProps, {
          style: (0, _extends2.default)({}, renderProps.style, _this2.state.style, style),
          className: (0, _classnames.default)(renderProps.className, className, inClassName),
