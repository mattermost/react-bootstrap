...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, (0, _react.cloneElement)(child, triggerProps), _reactDom.default.createPortal(this.makeOverlay(overlay, props), document.body));
  };
