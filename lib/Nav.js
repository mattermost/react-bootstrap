...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        props = (0, _objectWithoutPropertiesLoose2.default)(_this$props, ["stacked", "justified", "onSelect", "role", "navbar", "pullRight", "pullLeft", "className", "children", "navbarContext", "tabContainerContext"]);
    ...
    process.env.NODE_ENV !== "production" ? (0, _warning.default)(!(justified && propsNavbar), 'justified navbar `Nav`s are not supported') : void 0;
    ...
    return _react.default.createElement("ul", (0, _extends3.default)({
      ...
      return (0, _react.cloneElement)(child, (0, _extends3.default)({}, _this5.getTabProps(child, tabContainer, role, active, childOnSelect), {
        active: active,
        activeKey: activeKey,
...
var NavWithContext = _react.default.forwardRef(function (props, ref) {
  var navbarContext = (0, _react.useContext)(_NavbarContext.default);
  var tabContainerContext = (0, _react.useContext)(_TabContainerContext.default);
  return _react.default.createElement(Nav, (0, _extends3.default)({
    ref: ref
  }, props, {
...
var _default = (0, _bootstrapUtils.bsClass)('nav', (0, _bootstrapUtils.bsStyles)(['tabs', 'pills'], NavWithContext));
