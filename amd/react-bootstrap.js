...
var react_is_production = __webpack_require__(2691);
...
function curry(fn) {
  return function () {
    ...
    if (typeof last !== 'string' && (0,react_is_production/* isValidElementType */.Hy)(last)) {
...
function wrapFunctionComponent(Component, _ref3) {
  ...
  function WrappedComponent(props) {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(Component, resolved);
  }
...
function splitBsPropsAndOmit(props, omittedPropNames) {
  ...
  entries_default()(props).forEach(function (_ref5) {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var handleEnter = utils_createChainedFunction(this.handleEnter, withRef(onEnter, this.childRef));
    var handleEntering = utils_createChainedFunction(this.handleEntering, withRef(onEntering, this.childRef));
    var handleEntered = utils_createChainedFunction(this.handleEntered, withRef(onEntered, this.childRef));
    var handleExit = utils_createChainedFunction(this.handleExit, withRef(onExit, this.childRef));
    var handleExiting = utils_createChainedFunction(this.handleExiting, withRef(onExiting, this.childRef));
...
var Fade = external_root_React_commonjs2_react_commonjs_react_amd_react_default().forwardRef(function (_ref, ref) {
  ...
  var childRef = (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useRef)(null);
  ...
  var callbacks = {
    onEnter: (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(function () {
      return withRef(onEnter, childRef);
    }, [onEnter]),
    onEntering: (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(function () {
      return withRef(onEntering, childRef);
    }, [onEntering]),
    onEntered: (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(function () {
      return withRef(onEntered, childRef);
    }, [onEntered]),
    onExit: (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(function () {
      return withRef(onExit, childRef);
    }, [onExit]),
    onExiting: (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(function () {
      return withRef(onExiting, childRef);
    }, [onExiting]),
    onExited: (0,external_root_React_commonjs2_react_commonjs_react_amd_react_.useMemo)(function () {
      return withRef(onExited, childRef);
    }, [onExited])
  };
  return external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(esm_Transition, _extends({}, props, callbacks, {
    in: inProp,
    timeout: timeout,
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    var _this$props = this.props,
        ...
        props = _objectWithoutPropertiesLoose(_this$props, ["backdrop", "backdropClassName", "backdropStyle", "animation", "show", "className", "style", "children", "onEntering", "onExited"]);
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(src_ModalContext.Provider, {
      ...
      renderDialog: function renderDialog(renderProps) {
        return external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(src_ModalDialog, _extends({}, dialogProps, renderProps, {
...
var NavWithContext = external_root_React_commonjs2_react_commonjs_react_amd_react_default().forwardRef(function (props, ref) {
  ...
  return external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(Nav, _extends({
    ref: ref
  }, props, {
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement(esm_Overlay, _extends({}, props, {
      ...
      return external_root_React_commonjs2_react_commonjs_react_amd_react_default().cloneElement(child, _extends({}, overlayProps, {
        placement: placement,
...
var Popover = external_root_React_commonjs2_react_commonjs_react_amd_react_default().forwardRef(function (_ref, ref) {
  var _extends2;
  ...
  var _ref$placement = _ref.placement,
      ...
      style = _ref.style,
      children = _ref.children,
      props = _objectWithoutPropertiesLoose(_ref, ["placement", "positionTop", "positionLeft", "arrowOffsetTop", "arrowOffsetLeft", "arrowRef", "arrowStyle", "title", "className", "style", "children"]);
...
function (_React$Component) {
  ...
  function TabPane(props, context) {
    ...
    _this.handleExited = _this.handleExited.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.in = false;
    _this.paneRef = external_root_React_commonjs2_react_commonjs_react_amd_react_default().createRef();
    return _this;
  }
  ...
  _proto.renderPane = function renderPane(tabContainer) {
    ...
    var pane = external_root_React_commonjs2_react_commonjs_react_amd_react_default().createElement("div", _extends({
      ref: this.paneRef
    }, elementProps, {
      role: "tabpanel",
      "aria-hidden": !active,
...
var Tooltip = external_root_React_commonjs2_react_commonjs_react_amd_react_default().forwardRef(function (_ref, ref) {
  var _extends2;
